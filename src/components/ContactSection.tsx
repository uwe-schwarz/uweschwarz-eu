        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col justify-center">
            <div className="bg-card rounded-xl p-8 border border-border shadow-sm">
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">{t({ en: "Let's Connect", de: "Lass uns in Kontakt treten" })}</h3>
              ...
              {/* Social Links */}
              <div>
                <h4 className="text-lg font-medium mb-4">{t({ en: "Find me on", de: "Finde mich auf" })}</h4>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea 
                    id="message"
                    rows={5}
                    placeholder={t({ en: "Your message", de: "Deine Nachricht" })}
                    required
                  />
                </div>
